...
class ConfigVoxAE(object):
    def __init__(self, phase):
        ...
        # set as attributes
        print("----Voxel Autoencoder Configuration-----")
    ...
    def set_configuration(self):
        self.vox_dim = VOX_DIM # Dimension of the voxel grid
        ...
        self.loss_weights = {
            "loss_fpce_weight": 1.0,
            "loss_fnce_weight": 1.0,
        }
    ...
    def parse(self):
        ...
        parser.add_argument('--lr', type=float, default=6e-05, help="initial learning rate")
        parser.add_argument('--grad_clip', type=float, default=1.0, help="gradient clipping threshold")
        parser.add_argument('--warmup_step', type=int, default=35000, help="step size for learning rate warm up")
